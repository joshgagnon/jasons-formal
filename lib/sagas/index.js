...
exports.renderSaga = renderSaga;
function downloadSaga() {
    function render(action) {
        var data, response, body_1, json, responseData, blob, disposition, filename, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.put(actions_1.updateRender({
                        downloadStatus: 1 /* InProgress */
                ...
                case 2:
                    _a.trys.push([2, 9, , 11]);
                    if (!data.documentsToAppend) return [3 /*break*/, 4];
                    body_1 = new FormData();
                    json = __assign({}, data, { documentsToAppend: null });
                    body_1.append('json', JSON.stringify(json));
                    data.documentsToAppend.map(function (d, index) {
                        if (d.id) {
                            body_1.append('existingDocumentsToAppend[]', JSON.stringify(__assign({}, d, { index: index })));
                        }
                        else {
                            body_1.append('documentsToAppend[]', d, d.name);
                        }
                    });
                    return [4 /*yield*/, effects_1.call(axios_1.default.post, '/api/render', body_1, { responseType: 'arraybuffer' })];
                case 3:
                    response = _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, effects_1.call(axios_1.default.post, '/api/render', data, { responseType: 'arraybuffer' })];
                case 5:
                    response = _a.sent();
                    _a.label = 6;
                case 6:
                ...
                case 7:
                    _a.sent();
                    blob = new Blob([responseData], { type: response.headers['content-type'] });
...
exports.downloadSaga = downloadSaga;
function saveSaga() {
