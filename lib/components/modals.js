...
var SaveModal = /** @class */ (function (_super) {
...
var ConnectedSaveModal = react_redux_1.connect(function (state) {
    return {
        ...
        loading: state.saved.status !== 2 /* Complete */,
...
var ConnectedConfirmationDialog = react_redux_1.connect(function (state) { return (__assign({}, state.dialogs.confirmation)); }, function (dispatch) { return ({ dispatch: dispatch }); }, function (ownProps, dispatchProps) {
    return __assign({}, ownProps, { hide: function () { return dispatchProps.dispatch(actions_1.hideConfirmation({})); }, reject: function () {
...
var FileFormat = /** @class */ (function (_super) {
    ...
    FileFormat.prototype.render = function () {
        var FileFormatExtras = this.props.fileFormatExtras;
        return React.createElement(react_bootstrap_1.Form, { horizontal: true },
            ...
            React.createElement(redux_form_1.Field, { title: 'File Type', name: 'fileType', component: formLoader_1.ToggleButtonFieldRow, columnWidth: 9 },
                ...
                React.createElement(react_bootstrap_1.ToggleButton, { value: "odt" },
                    ...
                    "  ODT (.odt)")),
            FileFormatExtras && React.createElement(FileFormatExtras, { values: this.props.getFileValues() }));
    };
    return FileFormat;
}(React.PureComponent));
...
var Complete = /** @class */ (function (_super) {
    ...
    Complete.prototype.download = function () {
        ...
        this.props.download(__assign({}, preview_1.buildRenderObject(fileValues.filename, this.props.category, this.props.schemaName, this.props.getValues(), {}), fileValues));
    };
    Complete.prototype.render = function () {
        ...
        return (React.createElement(react_bootstrap_1.Modal, { show: true, onHide: this.props.handleClose, backdrop: "static" },
            ...
            React.createElement(react_bootstrap_1.Modal.Body, null,
                React.createElement(FileFormatForm, { ref: "form", initialValues: { fileType: 'docx', filename: filename }, fileFormatExtras: this.props.fileFormatExtras, getFileValues: this.props.getFileValues }),
...
var Modals = /** @class */ (function (_super) {
    ...
    Modals.prototype.render = function () {
        ...
        if (this.props.showing === 'complete') {
            return React.createElement(ConnectedComplete, { fileFormatExtras: this.props.fileFormatExtras });
        }
        return false;
    };
    return Modals;
...
var ConnectedModals = react_redux_1.connect(function (state) { return ({
    downloading: state.document.downloadStatus === 1 /* InProgress */,
