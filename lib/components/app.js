...
var AddDocuments = /** @class */ (function (_super) {
    __extends(AddDocuments, _super);
    function AddDocuments() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AddDocuments.prototype.render = function () {
...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return React.createElement("div", null,
            ...
            React.createElement(formLoader_1.default, { initialValues: { category: 'Evolution Templates', schema: 'vendors_settlement_statement' }, context: { 'users': [{ 'title': 'xx', 'value': { 'firstName': 'x', email: 'asdf' } }, { 'title': 'yy', 'value': { 'firstName': 'y', email: 'asdfasdfa' } }],
            ...
            React.createElement(modals_1.default, { fileFormatExtras: AddDocuments }));
    };
    return App;
}(React.PureComponent));
exports.App = App;
