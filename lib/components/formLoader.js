...
var SchemaField = /** @class */ (function (_super) {
    ...
    SchemaField.prototype.render = function () {
        ...
        keys.sort(function (a, b) { return schemas_1.default[_this.props.category].schemas[a].schema.title
            .localeCompare(schemas_1.default[_this.props.category].schemas[b].schema.title); });
